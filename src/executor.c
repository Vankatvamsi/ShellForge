...
int execute_command(command_t *cmd)
{
    ...
    if (pid == 0)
    {
        ...
        /*
         * The shell ignores SIGTSTP, but child processes must
         * use the default terminal signal behavior.
         */
    ...
    /*
     * Put the child in its own process group for both
    ...
    /*
     * Give the terminal to the foreground process group.
     */
    give_terminal_to(pid);


    /*
     * Wait until the process exits or is stopped by Ctrl+Z.
     */
    if (waitpid(
            pid,
            &status,
    ...
    /*
     * Foreground process finished, so return the terminal
     * to Shellforge.
     */
    take_terminal_back();
